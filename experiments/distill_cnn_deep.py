...
def main():
    ...
    savedir = os.path.abspath(f"results/basic_distillation/cnn_deep_distillation/rc_augmentation_expt/")
    hyperparams = f"{RC}/factor={args.factor}/temperature={args.temperature}/alpha={args.alpha}"
